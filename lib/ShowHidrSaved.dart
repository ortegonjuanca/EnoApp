                      ...
                      children: [
                                ...
                                child: Padding(
                                  ...
                                  child: RichText(
                                      ...
                                      text: TextSpan(
                                          ...
                                          children: <TextSpan>[
                                            new TextSpan(text: "El volumen de agua necesaria para obtener un vinagre de " + formatter.format(decimal_grado_vinagre_deseado.toDouble()) + "º es de "),
                        ...
                        Container(
                            ...
                            child: Card(
                                ...
                                child: Padding(
                                  padding: const EdgeInsets.only(top: 20, bottom: 20, left: 15, right: 15),
                                  child: Text(this.hidr.note, style: new TextStyle(fontSize: 16,),),
                                )
                            )
                        ),
                      ]
                ...
                children: <Widget>[
                  Align(
                      ...
                      child: FloatingActionButton(
                        heroTag: null,
                        onPressed: () async {
                          deleteFort(this.hidr.title, context);
                        },
